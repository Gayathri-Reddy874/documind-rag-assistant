...
<!--
  Update these paths to match the actual filenames inside your Screenshots/ folder.
  GitHub renders images relative to the README's location, so `Screenshots/<file>.png` works as-is.
-->

| Home / Upload | Chat with Sources |
|---|---|
| ![App home screen with document upload sidebar](Screenshots/app-home.png) | ![Chat interface showing an answer with cited source chunks](Screenshots/chat-with-sources.png) |

<p align="center">
  <img alt="Sidebar configuration panel" src="Screenshots/sidebar-config.png" width="70%">
</p>
